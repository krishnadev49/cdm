...
{
    $stname=$_POST['stname'];
    $sel=  mysqli_query($dbcon,"select * from state_tbl where state_name='$stname'");
...
<?php
    ...
    $ins=  mysqli_query($dbcon,"insert into state_tbl values('','$stname','0','0','0','0','0','0')");
    if($ins>0)
    {
...
if(isset($_POST['reg']))
{
    ...
    $up=  mysqli_query($dbcon,"update state_tbl set sadmin_name='$sadmin',sadmin_emailid='$semail',sadmin_password='$pswd',sadmin_contact='$cnt',sadmin_photo='$f3',sadmin_status='0' where state_id='$s'");
    if($up>0)
    {
        $log=  mysqli_query($dbcon,"insert into login_tbl values('','$semail','$pswd','sadmin','1')");
...
<body>
                            ...
                            <div class="error-right col-xl-6">
                                ...
                                <form method="post" enctype="multipart/form-data">
                                    ...
                                    <table class="table  table-responsive table-hover">
                                        <?php
                                        $ss=  mysqli_query($dbcon,"select * from state_tbl where state_id='$s'");
  ...
  <?php
  $qw=  mysqli_query($dbcon,"select * from state_tbl");
