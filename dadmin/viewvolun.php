...
<body>
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <!-- main-heading -->
            <h2 class="main-title-w3layouts mb-2 text-center">View Volunteers</h2>
            <!--// main-heading -->
...
<div class="container">
	<div class="row">
            <?php
            $rc=  mysql_query("select * from registeruser_tbl where user_response='volunteer' and user_district='$rv1[0]'");
