...
<body>
    <div class="wrapper">
        ...
        <div id="content">
            ...
            <!-- main-heading -->
            <h2 class="main-title-w3layouts mb-2 text-center">View Users</h2>
            <!--// main-heading -->
...
<div class="container">
	<div class="row">
            <?php
            $rc=  mysql_query("select * from registeruser_tbl where user_response='user' and user_district='$rv1[0]'");
		...
		<div class="col-lg-3 col-sm-6">
            ...
            <div class="card hovercard">
                ...
                <div class="avatar">
                    <img alt="" src="../userpic/<?php echo $rc1[9]?>">
                </div>
                <div class="info">
                    <div class="title">
                        <a target="_blank" href=""><?php echo $rc1[1]?></a>
                    </div>
                    <div class="desc"><?php echo $rc1[2]?></div>
                    <div class="desc"><?php echo $rc1[3]?></div>
                    <div class="desc"><img src="images/phone.png"style="width:20px;height: 20px;"><?php echo $rc1[4]?></div>
